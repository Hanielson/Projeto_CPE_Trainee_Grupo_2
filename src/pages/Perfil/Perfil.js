...
export default function Perfil() {
  ...
  const [frase, setFrase] = useState(
    "Lorem tipsum dolor sit amet, consectetur adipiscing"
  );
      ...
      <div className={"perfil"}>
        <div className={"areaPerfil"}>
          <img
            ...
            src="https://i.ibb.co/xmHn68K/perfil.png"
          />
