...
// {Caracteres que são aceitos no input type="number" }
  ...
  async function cadastro(){
    try {
      ...
      const response_endereco = await api.post(`/endereco/${user_id}`, {rua, numero, cidade, estado, pais});
      history.push("/login");
        ...
        <div className="botoes_inputs">
          ...
          <div>
            <div className="botaoCadastrar">
              <button className="botaoCadastrar" type = "button" value = "text" onClick={cadastro}>Cadastrar</button>
            </div>
            <div>
